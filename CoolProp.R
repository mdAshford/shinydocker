...
##	 C:/swigwin-3.0.12/swig.exe -r -outdir C:/CoolProp-windows-DTU-slave/R-windows/build/build -c++ -IC:/CoolProp-windows-DTU-slave/R-windows/build -IC:/CoolProp-windows-DTU-slave/R-windows/build/externals/Eigen -IC:/CoolProp-windows-DTU-slave/R-windows/build/externals/msgpack-c/include -IC:/CoolProp-windows-DTU-slave/R-windows/build/externals/fmtlib/include -IC:/CoolProp-windows-DTU-slave/R-windows/build/externals/fmtlib -IC:/CoolProp-windows-DTU-slave/R-windows/build/include -IC:/CoolProp-windows-DTU-slave/R-windows/build/src -IC:/PROGRA~1/R/R-35~1.1/include -o C:/CoolProp-windows-DTU-slave/R-windows/build/build/CMakeFiles/CoolProp.dir/CoolPropR_wrap.cxx C:/CoolProp-windows-DTU-slave/R-windows/build/src/CoolProp.i
...
setClass('_p_CoolProp__AbstractStateGenerator', contains = 'C++Reference')
...
{
  accessorFuns = list('__nonzero__' = DoubleVector___nonzero__, '__len__' = DoubleVector___len__, 'pop' = DoubleVector_pop, '__getslice__' = DoubleVector___getslice__, '__setslice__' = DoubleVector___setslice__, '__delslice__' = DoubleVector___delslice__, '__delitem__' = DoubleVector___delitem__, '__getitem__' = DoubleVector___getitem__, '__setitem__' = DoubleVector___setitem__, 'append' = DoubleVector_append, 'empty' = DoubleVector_empty, 'size' = DoubleVector_size, 'swap' = DoubleVector_swap, 'clear' = DoubleVector_clear, 'get_allocator' = DoubleVector_get_allocator, 'pop_back' = DoubleVector_pop_back, 'resize' = DoubleVector_resize, 'push_back' = DoubleVector_push_back, 'front' = DoubleVector_front, 'back' = DoubleVector_back, 'assign' = DoubleVector_assign, 'reserve' = DoubleVector_reserve, 'capacity' = DoubleVector_capacity);
...
attr(`VectorOfDoubleVector___nonzero__`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector___len__`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_pop`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector___getslice__`, 'returnType') = 'list'
attr(`VectorOfDoubleVector___getslice__`, "inputTypes") = c('list', 'integer', 'integer')
...
attr(`VectorOfDoubleVector___setslice__`, "inputTypes") = c('list', 'integer', 'integer', 'list')
...
attr(`VectorOfDoubleVector___delslice__`, "inputTypes") = c('list', 'integer', 'integer')
...
attr(`VectorOfDoubleVector___delitem__`, "inputTypes") = c('list', 'integer')
...
attr(`VectorOfDoubleVector___getitem__`, "inputTypes") = c('list', 'integer')
...
attr(`VectorOfDoubleVector___setitem__`, "inputTypes") = c('list', 'integer', '_p_std__vectorT_double_std__allocatorT_double_t_t')
...
attr(`VectorOfDoubleVector_append`, "inputTypes") = c('list', '_p_std__vectorT_double_std__allocatorT_double_t_t')
...
attr(`VectorOfDoubleVector__SWIG_0`, 'returnType') = 'list'
...
attr(`VectorOfDoubleVector__SWIG_1`, 'returnType') = 'list'
attr(`VectorOfDoubleVector__SWIG_1`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_empty`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_size`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_swap`, "inputTypes") = c('list', 'list')
...
attr(`VectorOfDoubleVector_clear`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_get_allocator`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector__SWIG_2`, 'returnType') = 'list'
...
attr(`VectorOfDoubleVector_pop_back`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_resize__SWIG_0`, "inputTypes") = c('list', 'integer')
...
attr(`VectorOfDoubleVector__SWIG_3`, 'returnType') = 'list'
...
attr(`VectorOfDoubleVector_push_back`, "inputTypes") = c('list', '_p_std__vectorT_double_std__allocatorT_double_t_t')
...
attr(`VectorOfDoubleVector_front`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_back`, "inputTypes") = c('list')
...
attr(`VectorOfDoubleVector_assign`, "inputTypes") = c('list', 'integer', '_p_std__vectorT_double_std__allocatorT_double_t_t')
...
attr(`VectorOfDoubleVector_resize__SWIG_1`, "inputTypes") = c('list', 'integer', '_p_std__vectorT_double_std__allocatorT_double_t_t')
...
attr(`VectorOfDoubleVector_reserve`, "inputTypes") = c('list', 'integer')
...
attr(`VectorOfDoubleVector_capacity`, "inputTypes") = c('list')
...
attr(`delete_VectorOfDoubleVector`, "inputTypes") = c('list')
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ;.Call('R_swig_VectorOfStringVector_pop', self, as.logical(.copy), PACKAGE='CoolProp');
  
}

attr(`VectorOfStringVector_pop`, 'returnType') = 'character'
...
# Start of is_valid_phase

`is_valid_phase` = function(phase_name, iOutput, .copy = FALSE)
{
  phase_name = as(phase_name, "character"); 
  iOutput = enumToInteger(iOutput, "_p_CoolProp__phases"); 
  ;.Call('R_swig_is_valid_phase', phase_name, iOutput, as.logical(.copy), PACKAGE='CoolProp');
  
}

attr(`is_valid_phase`, 'returnType') = 'logical'
attr(`is_valid_phase`, "inputTypes") = c('character', 'character')
class(`is_valid_phase`) = c("SWIGFunction", class('is_valid_phase'))
...
# Start of GuessesStructure_clear

`GuessesStructure_clear` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ;.Call('R_swig_GuessesStructure_clear', self, PACKAGE='CoolProp');
  
}

attr(`GuessesStructure_clear`, 'returnType') = 'void'
attr(`GuessesStructure_clear`, "inputTypes") = c('_p_CoolProp__GuessesStructure')
class(`GuessesStructure_clear`) = c("SWIGFunction", class('GuessesStructure_clear'))
...
{
  accessorFuns = list('T' = GuessesStructure_T_get, 'p' = GuessesStructure_p_get, 'rhomolar' = GuessesStructure_rhomolar_get, 'hmolar' = GuessesStructure_hmolar_get, 'smolar' = GuessesStructure_smolar_get, 'rhomolar_liq' = GuessesStructure_rhomolar_liq_get, 'rhomolar_vap' = GuessesStructure_rhomolar_vap_get, 'x' = GuessesStructure_x_get, 'y' = GuessesStructure_y_get, 'clear' = GuessesStructure_clear);
...
# Start of AbstractState_set_reference_stateS

`AbstractState_set_reference_stateS` = function(self, reference_state)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  reference_state = as(reference_state, "character"); 
  ;.Call('R_swig_AbstractState_set_reference_stateS', self, reference_state, PACKAGE='CoolProp');
  
}

attr(`AbstractState_set_reference_stateS`, 'returnType') = 'void'
attr(`AbstractState_set_reference_stateS`, "inputTypes") = c('_p_CoolProp__AbstractState', 'character')
class(`AbstractState_set_reference_stateS`) = c("SWIGFunction", class('AbstractState_set_reference_stateS'))

# Start of AbstractState_set_reference_stateD

`AbstractState_set_reference_stateD` = function(self, T, rhomolar, hmolar0, smolar0)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ...
  ;.Call('R_swig_AbstractState_set_reference_stateD', self, T, rhomolar, hmolar0, smolar0, PACKAGE='CoolProp');
  
}

attr(`AbstractState_set_reference_stateD`, 'returnType') = 'void'
attr(`AbstractState_set_reference_stateD`, "inputTypes") = c('_p_CoolProp__AbstractState', 'numeric', 'numeric', 'numeric', 'numeric')
class(`AbstractState_set_reference_stateD`) = c("SWIGFunction", class('AbstractState_set_reference_stateD'))
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  mole_fractions = as.numeric(mole_fractions);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  mass_fractions = as.numeric(mass_fractions);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  volu_fractions = as.numeric(volu_fractions);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ;.Call('R_swig_AbstractState_fluid_names', self, as.logical(.copy), PACKAGE='CoolProp');
  
}

attr(`AbstractState_fluid_names`, 'returnType') = 'character'
...
# Start of AbstractState_get_fluid_constant

`AbstractState_get_fluid_constant` = function(self, i, param, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  i = as.integer(i);
  ...
  ;.Call('R_swig_AbstractState_get_fluid_constant', self, i, param, as.logical(.copy), PACKAGE='CoolProp');
  
}

attr(`AbstractState_get_fluid_constant`, 'returnType') = 'numeric'
attr(`AbstractState_get_fluid_constant`, "inputTypes") = c('_p_CoolProp__AbstractState', 'integer', 'character')
class(`AbstractState_get_fluid_constant`) = c("SWIGFunction", class('AbstractState_get_fluid_constant'))
...
`AbstractState_set_binary_interaction_string__SWIG_0` = function(self, CAS1, CAS2, parameter, value)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  CAS1 = as(CAS1, "character"); 
  CAS2 = as(CAS2, "character"); 
  parameter = as(parameter, "character"); 
  value = as(value, "character"); 
  ;.Call('R_swig_AbstractState_set_binary_interaction_string__SWIG_0', self, CAS1, CAS2, parameter, value, PACKAGE='CoolProp');
  
}

attr(`AbstractState_set_binary_interaction_string__SWIG_0`, 'returnType') = 'void'
attr(`AbstractState_set_binary_interaction_string__SWIG_0`, "inputTypes") = c('_p_CoolProp__AbstractState', 'character', 'character', 'character', 'character')
class(`AbstractState_set_binary_interaction_string__SWIG_0`) = c("SWIGFunction", class('AbstractState_set_binary_interaction_string__SWIG_0'))

# Start of AbstractState_set_binary_interaction_string

`AbstractState_set_binary_interaction_string__SWIG_1` = function(self, i, j, parameter, value)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  i = as.integer(i);
  ...
  parameter = as(parameter, "character"); 
  value = as(value, "character"); 
  ;.Call('R_swig_AbstractState_set_binary_interaction_string__SWIG_1', self, i, j, parameter, value, PACKAGE='CoolProp');
  
}

attr(`AbstractState_set_binary_interaction_string__SWIG_1`, 'returnType') = 'void'
attr(`AbstractState_set_binary_interaction_string__SWIG_1`, "inputTypes") = c('_p_CoolProp__AbstractState', 'integer', 'integer', 'character', 'character')
class(`AbstractState_set_binary_interaction_string__SWIG_1`) = c("SWIGFunction", class('AbstractState_set_binary_interaction_string__SWIG_1'))

`AbstractState_set_binary_interaction_string` <- function(...) {
  argtypes <- mapply(class, list(...));
  argv <- list(...);
  argc <- length(argtypes);
# dispatch functions 2
  if (argc == 5) {
    if (extends(argtypes[1], '_p_CoolProp__AbstractState') && ( (is.integer(argv[[2]]) || is.numeric(argv[[2]])) && length(argv[[2]]) == 1 ) && ( (is.integer(argv[[3]]) || is.numeric(argv[[3]])) && length(argv[[3]]) == 1 ) && is.character(argv[[4]]) && length(argv[[4]]) == 1 && is.character(argv[[5]]) && length(argv[[5]]) == 1) {
      f <- AbstractState_set_binary_interaction_string__SWIG_1; 
    }
    else if (extends(argtypes[1], '_p_CoolProp__AbstractState') && is.character(argv[[2]]) && length(argv[[2]]) == 1 && is.character(argv[[3]]) && length(argv[[3]]) == 1 && is.character(argv[[4]]) && length(argv[[4]]) == 1 && is.character(argv[[5]]) && length(argv[[5]]) == 1) {
      f <- AbstractState_set_binary_interaction_string__SWIG_0; 
    }
  } else {
    stop("cannot find overloaded function for AbstractState_set_binary_interaction_string with argtypes (",toString(argtypes),")");
  };
  f(...);
}
...
# Start of AbstractState_set_cubic_alpha_C

`AbstractState_set_cubic_alpha_C` = function(self, i, parameter, c1, c2, c3)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  i = as.integer(i);
  ...
  ;.Call('R_swig_AbstractState_set_cubic_alpha_C', self, i, parameter, c1, c2, c3, PACKAGE='CoolProp');
  
}

attr(`AbstractState_set_cubic_alpha_C`, 'returnType') = 'void'
attr(`AbstractState_set_cubic_alpha_C`, "inputTypes") = c('_p_CoolProp__AbstractState', 'integer', 'character', 'numeric', 'numeric', 'numeric')
class(`AbstractState_set_cubic_alpha_C`) = c("SWIGFunction", class('AbstractState_set_cubic_alpha_C'))
...
# Start of AbstractState_get_fluid_parameter_double

`AbstractState_get_fluid_parameter_double` = function(self, i, parameter, .copy = FALSE)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  i = as.integer(i);
  ...
  parameter = as(parameter, "character"); 
  ;.Call('R_swig_AbstractState_get_fluid_parameter_double', self, i, parameter, as.logical(.copy), PACKAGE='CoolProp');
  
}

attr(`AbstractState_get_fluid_parameter_double`, 'returnType') = 'numeric'
attr(`AbstractState_get_fluid_parameter_double`, "inputTypes") = c('_p_CoolProp__AbstractState', 'integer', 'character')
class(`AbstractState_get_fluid_parameter_double`) = c("SWIGFunction", class('AbstractState_get_fluid_parameter_double'))
...
# Start of AbstractStateGenerator_get_AbstractState

`AbstractStateGenerator_get_AbstractState` = function(self, fluid_names)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  if (inherits(fluid_names, "ExternalReference")) fluid_names = slot(fluid_names,"ref") 
  ;ans = .Call('R_swig_AbstractStateGenerator_get_AbstractState', self, fluid_names, PACKAGE='CoolProp');
  ans <- new("_p_CoolProp__AbstractState", ref=ans) ;
...
attr(`AbstractStateGenerator_get_AbstractState`, 'returnType') = '_p_CoolProp__AbstractState'
attr(`AbstractStateGenerator_get_AbstractState`, "inputTypes") = c('_p_CoolProp__AbstractStateGenerator', '_p_std__vectorT_std__string_std__allocatorT_std__string_t_t')
class(`AbstractStateGenerator_get_AbstractState`) = c("SWIGFunction", class('AbstractStateGenerator_get_AbstractState'))

# Start of delete_AbstractStateGenerator

`delete_AbstractStateGenerator` = function(self)
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  ;.Call('R_swig_delete_AbstractStateGenerator', self, PACKAGE='CoolProp');
  
}

attr(`delete_AbstractStateGenerator`, 'returnType') = 'void'
attr(`delete_AbstractStateGenerator`, "inputTypes") = c('_p_CoolProp__AbstractStateGenerator')
class(`delete_AbstractStateGenerator`) = c("SWIGFunction", class('delete_AbstractStateGenerator'))

# Start of accessor method for CoolProp::AbstractStateGenerator
setMethod('$', '_p_CoolProp__AbstractStateGenerator', function(x, name)

{
  accessorFuns = list('get_AbstractState' = AbstractStateGenerator_get_AbstractState);
  ;        idx = pmatch(name, names(accessorFuns));
  if(is.na(idx)) 
  return(callNextMethod(x, name));
  f = accessorFuns[[idx]];
...
# end of accessor method for CoolProp::AbstractStateGenerator
setMethod('delete', '_p_CoolProp__AbstractStateGenerator', function(obj) {delete_CoolProp__AbstractStateGenerator(obj)})
# Start of register_backend

`register_backend` = function(bf, gen)
{
  bf = enumToInteger(bf, "_p_CoolProp__backend_families"); 
  if (inherits(gen, "ExternalReference")) gen = slot(gen,"ref") 
  ;.Call('R_swig_register_backend', bf, gen, PACKAGE='CoolProp');
  
}

attr(`register_backend`, 'returnType') = 'void'
attr(`register_backend`, "inputTypes") = c('character', '_p_shared_ptrT_CoolProp__AbstractStateGenerator_t')
class(`register_backend`) = c("SWIGFunction", class('register_backend'))
...
# Start of phase_lookup_string

`phase_lookup_string` = function(Phase, .copy = FALSE)
{
  Phase = enumToInteger(Phase, "_CoolProp__phases"); 
  ...
  ;.Call('R_swig_phase_lookup_string', Phase, as.logical(.copy), PACKAGE='CoolProp');
  
}

attr(`phase_lookup_string`, 'returnType') = 'character'
attr(`phase_lookup_string`, "inputTypes") = c('character')
class(`phase_lookup_string`) = c("SWIGFunction", class('phase_lookup_string'))
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_rhomolar_liq = as.numeric(s_rhomolar_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_rhomolar_vap = as.numeric(s_rhomolar_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_lnrhomolar_liq = as.numeric(s_lnrhomolar_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_lnrhomolar_vap = as.numeric(s_lnrhomolar_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_hmolar_liq = as.numeric(s_hmolar_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_hmolar_vap = as.numeric(s_hmolar_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_smolar_liq = as.numeric(s_smolar_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_smolar_vap = as.numeric(s_smolar_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_cpmolar_liq = as.numeric(s_cpmolar_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_cpmolar_vap = as.numeric(s_cpmolar_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_cvmolar_liq = as.numeric(s_cvmolar_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_cvmolar_vap = as.numeric(s_cvmolar_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_viscosity_liq = as.numeric(s_viscosity_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_viscosity_vap = as.numeric(s_viscosity_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_conductivity_liq = as.numeric(s_conductivity_liq);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_conductivity_vap = as.numeric(s_conductivity_vap);
...
{
  if (inherits(self, "ExternalReference")) self = slot(self,"ref") 
  s_speed_sound_vap = as.numeric(s_speed_sound_vap);
...
attr(`PhaseEnvelopeData_K_get`, 'returnType') = 'list'
...
attr(`PhaseEnvelopeData_lnK_get`, 'returnType') = 'list'
...
attr(`PhaseEnvelopeData_x_get`, 'returnType') = 'list'
...
attr(`PhaseEnvelopeData_y_get`, 'returnType') = 'list'
...
defineEnumeration('_configuration_keys',
                    .values = c(
                        ...
                        'ALTERNATIVE_REFPROP_LIBRARY_PATH' = 7, 
                        'REFPROP_DONT_ESTIMATE_INTERACTION_PARAMETERS' = 8, 
                        'REFPROP_IGNORE_ERROR_ESTIMATED_INTERACTION_PARAMETERS' = 9, 
                        'REFPROP_USE_GERG' = 10, 
                        'REFPROP_USE_PENGROBINSON' = 11, 
                        'MAXIMUM_TABLE_DIRECTORY_SIZE_IN_GB' = 12, 
                        'DONT_CHECK_PROPERTY_LIMITS' = 13, 
                        'HENRYS_LAW_TO_GENERATE_VLE_GUESSES' = 14, 
                        'PHASE_ENVELOPE_STARTING_PRESSURE_PA' = 15, 
                        'R_U_CODATA' = 16, 
                        'VTPR_UNIFAC_PATH' = 17, 
                        'SPINODAL_MINIMUM_DELTA' = 18, 
                        'OVERWRITE_FLUIDS' = 19, 
                        'OVERWRITE_DEPARTURE_FUNCTION' = 20, 
                        'OVERWRITE_BINARY_INTERACTION' = 21, 
                        'USE_GUESSES_IN_PROPSSI' = 22, 
                        'ASSUME_CRITICAL_POINT_STABLE' = 23, 
                        'VTPR_ALWAYS_RELOAD_LIBRARY' = 24, 
                        'FLOAT_PUNCTUATION' = 25
))
